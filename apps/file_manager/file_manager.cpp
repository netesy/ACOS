...
void FileManager::browse(const char* path) {
    ...
    // Store current path
    usize path_len = acos::runtime::strlen(path);
    if (path_len >= 255) return;
    
    acos::runtime::memcpy(m_current_path, path, path_len);
    m_current_path[path_len] = '\0';
    
    // Add parent directory entry if not root
    if (acos::runtime::strcmp(path, "/") != 0) {
...
void FileManager::navigate_to(const char* entry_name) {
    ...
    if (acos::runtime::strcmp(entry_name, "..") == 0) {
        navigate_parent();
        return;
    }
    ...
    // Build new path
    char new_path[256];
    usize current_len = acos::runtime::strlen(m_current_path);
    
    // Handle root path specially
    if (acos::runtime::strcmp(m_current_path, "/") == 0) {
...
void FileManager::navigate_parent() {
    ...
    // Find last slash
    char new_path[256];
    acos::runtime::memcpy(new_path, m_current_path, 256);
    
    usize len = acos::runtime::strlen(new_path);
...
void FileManager::enumerate_directory_fallback(const char* path) {
    ...
    // Home directory
    else if (acos::runtime::strcmp(path, "/home") == 0) {
        m_file_list.add_item("user");
        m_file_list.add_item("guest");
    }
    // User home
    else if (acos::runtime::strcmp(path, "/home/user") == 0) {
    ...
    // Guest home
    else if (acos::runtime::strcmp(path, "/home/guest") == 0) {
        m_file_list.add_item("Documents");
        m_file_list.add_item("Downloads");
        m_file_list.add_item(".bashrc");
    }
    // Documents
    else if (acos::runtime::strcmp(path, "/home/user/Documents") == 0) {
    ...
    // Guest Documents
    else if (acos::runtime::strcmp(path, "/home/guest/Documents") == 0) {
        m_file_list.add_item("readme.txt");
        m_file_list.add_item("notes.md");
    }
    // Downloads
    else if (acos::runtime::strcmp(path, "/home/user/Downloads") == 0) {
    ...
    // Guest Downloads
    else if (acos::runtime::strcmp(path, "/home/guest/Downloads") == 0) {
        m_file_list.add_item("file.zip");
    }
    // Pictures
    else if (acos::runtime::strcmp(path, "/home/user/Pictures") == 0) {
    ...
    // Music
    else if (acos::runtime::strcmp(path, "/home/user/Music") == 0) {
    ...
    // Videos
    else if (acos::runtime::strcmp(path, "/home/user/Videos") == 0) {
    ...
    // Etc directory
    else if (acos::runtime::strcmp(path, "/etc") == 0) {
    ...
    // Bin directory
    else if (acos::runtime::strcmp(path, "/bin") == 0) {
    ...
    // Boot directory
    else if (acos::runtime::strcmp(path, "/boot") == 0) {
    ...
    // Lib directory
    else if (acos::runtime::strcmp(path, "/lib") == 0) {
    ...
    // Usr directory
    else if (acos::runtime::strcmp(path, "/usr") == 0) {
        m_file_list.add_item("bin");
        m_file_list.add_item("lib");
    ...
    // Usr/bin directory
    else if (acos::runtime::strcmp(path, "/usr/bin") == 0) {
    ...
    // Var directory
    else if (acos::runtime::strcmp(path, "/var") == 0) {
    ...
    // Var/log directory
    else if (acos::runtime::strcmp(path, "/var/log") == 0) {
...
bool FileManager::is_directory(const char* entry_name) {
    ...
    if (acos::runtime::strcmp(entry_name, "..") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "bin") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "boot") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "dev") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "etc") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "home") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "lib") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "mnt") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "opt") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "proc") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "root") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "run") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "sys") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "tmp") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "usr") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "var") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "Documents") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "Downloads") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "Pictures") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "Music") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "Videos") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "user") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "guest") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "config") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "log") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "cache") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "include") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "share") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "local") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "subdirectory") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "src") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "spool") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "usb") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "cdrom") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "external") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "applications") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "tools") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "doc") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "man") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "locale") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "icons") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "fonts") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "apt") == 0) return true;
    if (acos::runtime::strcmp(entry_name, "fontconfig") == 0) return true;
