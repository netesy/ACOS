...
void font_init() {
    ...
    static const u8 font_data[95][8] = {
        // Space (32)
        ...
        // K (75)
        {0x66, 0x66, 0x36, 0x1E, 0x36, 0x66, 0x66, 0x00},
        // L (76)
        ...
        // P (80)
        {0x7F, 0x66, 0x66, 0x7E, 0x06, 0x06, 0x0F, 0x00},
        // Q (81)
        {0x3C, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x78, 0x00},
        // R (82)
        {0x7F, 0x66, 0x66, 0x7E, 0x36, 0x66, 0x66, 0x00},
        // S (83)
        {0x3C, 0x66, 0x06, 0x1C, 0x60, 0x66, 0x3C, 0x00},
        // T (84)
        {0x7E, 0x7E, 0x18, 0x18, 0x18, 0x18, 0x3C, 0x00},
        // U (85)
    ...
    // Initialize font array with the data
    for (int i = 0; i < 128; i++) {
        for (int j = 0; j < 8; j++) {
            if (i >= 32 && i < 127) {
                font8x8_basic[i][j] = font_data[i - 32][j];
            } else {
                font8x8_basic[i][j] = 0;
            }
        }
